...
import ImagefieldPreview from '../previews/ImagefieldPreview';
...
const ImageField = (props) => {
    ...
    const [type] = useState(fieldData ? fieldData.type : 'image')
        ...
        >
                            ...
                            {conditional ?
                                <>
                                    ...
                                    <Select
                                        ...
                                        onChange={handleWhen}
                                    >
                                        {allFormFields(componentsData, id, 'image').map((option, index) => (
                                            <MenuItem
                                                key={index}
                                                value={option.id}
            ...
            <DialogActions>
                ...
                >
                    ...
                    >Cancel</Button>
                    <Button
                        onClick={fieldData?handleUpdate:addImageField}
                        variant="outlined"
                        size='small'
                        color="success"
